 ...
 *
 * phos_emul copy: default page size is 2 MB, the conventional CC
 * whole-image chunk size. Avoids the per-page EVP_EncryptInit overhead
 * that dominates at 4 KB granularity for multi-GB checkpoints.
 *
...
#define CKPT_CRYPTO_PAGE_SIZE   (2u * 1024u * 1024u)   /* 2 MB — baseline whole-image */
